...
import javax.swing.*;
class DeletDoctor extends JFrame implements  ActionListener
{
   ...
   DeletDoctor()
   {
      ...
      lblId=new JLabel("Id");
      lblId.setBounds(200, 130, 100, 30);
      this.add(lblId);
          ...
          String DB_URL = "jdbc:mysql://localhost:3306/JagrutiHospital";
              ...
              String PASS = "";
               try {
                  ...
                  String sql = "Delete from doctor WHERE Id = "+textFieldId.getText();
   ...
   {
       DeletDoctor ob2=new DeletDoctor();
   }
}
